...
import devWorkstationImg from "../assets/dev-workstation.png";
import avatarsGroupImg from "../assets/avatars-group.png";
import sessionConductImg from "../assets/session-conduct.png";
                ...
                <div className="arcade-columns-grid">
                    ...
                    <div className="arcade-card card-red-theme highlight-cohort">
                        ...
                        <button
                            ...
                            onClick={handleApply}
                        >
                            {applied ? "REDIRECTING TO FORM..." : "START APPLICATION"}
                        </button>
                    </div>
                </div>
