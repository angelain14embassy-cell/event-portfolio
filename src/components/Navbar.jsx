    ...
    <>
      ...
      <style>{`
        ...
        .light-theme .nav-glass-container {
          background: linear-gradient(135deg, rgba(255, 255, 255, 0.92) 0%, rgba(239, 246, 255, 0.95) 100%);
          backdrop-filter: blur(16px);
          -webkit-backdrop-filter: blur(16px);
        ...
        .dark-theme .brand-title { color: #ffffff; font-weight: 800; font-size: 0.72rem; }
        .light-theme .brand-title { color: #1e3a8a; font-weight: 800; font-size: 0.72rem; }
        ...
        .nav-divider { width: 1px; height: 16px; }
        ...
        .nav-single-btn:hover { transform: scale(1.15); z-index: 10; }
        .dark-theme .nav-single-btn:hover { background: linear-gradient(135deg, #6366f1 0%, #3b82f6 100%); color: #ffffff; box-shadow: 0 4px 14px rgba(99, 102, 241, 0.45); }
        .light-theme .nav-single-btn:hover { background: linear-gradient(135deg, #60a5fa 0%, #2563eb 100%); color: #ffffff; box-shadow: 0 4px 14px rgba(37, 99, 235, 0.35); }

        .dark-theme .nav-single-btn.active { background: linear-gradient(135deg, #4f46e5 0%, #3b82f6 100%); color: #ffffff; box-shadow: 0 3px 10px rgba(79, 70, 229, 0.4); }
        .light-theme .nav-single-btn.active { background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); color: #ffffff; box-shadow: 0 3px 10px rgba(37, 99, 235, 0.3); }
        ...
        .dark-theme .tooltip-box { background: #0f172a; border: 1px solid rgba(255, 255, 255, 0.15); box-shadow: 0 8px 20px rgba(0,0,0,0.5); }
        .light-theme .tooltip-box { background: #ffffff; border: 1px solid rgba(191, 219, 254, 0.9); box-shadow: 0 8px 20px rgba(37, 99, 235, 0.15); }

        .nav-single-btn:hover .tooltip-box { opacity: 1; visibility: visible; transform: translateX(-50%) translateY(0); }

        .tooltip-main { font-size: 0.65rem; font-weight: 700; }
        .dark-theme .tooltip-main { color: #f8fafc; }
        .light-theme .tooltip-main { color: #0f172a; }
        ...
        .dark-theme .join-tier-btn { background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%); color: #ffffff; box-shadow: 0 3px 10px rgba(99, 102, 241, 0.35); }
        .light-theme .join-tier-btn { background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%); color: #ffffff; box-shadow: 0 3px 10px rgba(37, 99, 235, 0.35); }
        ...
        .m-main { font-size: 0.82rem; font-weight: 700; }
        .m-sub { font-size: 0.62rem; font-weight: 600; opacity: 0.7; }
